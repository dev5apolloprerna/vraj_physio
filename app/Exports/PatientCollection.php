...
class PatientCollection implements FromCollection, WithHeadings
{
    protected $plist;
    protected $fromDate;
    protected $toDate;
    ...
    public function __construct($plist, $fromDate = null, $toDate = null,$Month= null ,$Year= null)
    {
    ...
    {
        return [
            ['Total Patient Collection Report'], // Title Row (Bold)
